...
__device__ bool intersectRayDisk(const ray_t r, const disk_t disk, dfloat *pt_t){
...
__device__ bool intersectRayCylinder(const ray_t r, const cylinder_t cylinder, dfloat *pt_t){
...
__device__ bool intersectRayCone(const ray_t r, const cone_t cone, dfloat *pt_t){
